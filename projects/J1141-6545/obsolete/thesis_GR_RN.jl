...
basic_settings = settings = bsets = BasicTempoSettings(
    work_dir = "/Users/abatrakov/Documents/Work/PhD/projects/J1141-6545/full_data_thesis/DDSTG_GR_RN",
    version = Tempo2(),
    par_file_init = "DDSTG_GR_RN$TNRedC.par",
...
ref_sets = RefinementSettings(
    params_to_save = (:chisqr, :rms_post_fit, :rms_tn_post_fit, :EFACs_EQUADs_max_objective, :F0, :F1, :F2, :DM, :PB, :T0, :A1, :OM, :ECC, :PBDOT, :XDOT, :X2DOT, :OMDOT, :M2, :MTOT, :GAMMA, :I, :IDOT),
...
for i in 0:3
    ...
    legend(fontsize=12)
    tight_layout()
    savefig("saves/GR_RN$(TNRedC)_200d_$i.pdf", format="pdf")

    save("saves/tf_GR_RN$(TNRedC)_200d_$i.jld", "tf", tf)
