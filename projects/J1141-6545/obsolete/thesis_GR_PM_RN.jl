...
basic_settings = settings = bsets = BasicTempoSettings(
    work_dir = "/Users/abatrakov/Documents/Work/PhD/projects/J1141-6545/full_data_thesis/DDSTG_GR_PM_RN",
    version = Tempo2(),
    par_file_init = "DDSTG_GR_PM_RN$TNRedC.par",
...
for i in 0:3
    ...
    legend(fontsize=12)
    tight_layout()
    savefig("saves/GR_PM_RN$(TNRedC)_200d_$i.pdf", format="pdf")

    save("saves/tf_GR_PM_RN$(TNRedC)_200d_$i.jld", "tf", tf)
